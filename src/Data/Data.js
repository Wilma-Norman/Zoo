...
export const Echidna = {
  lifespan: "50 years",
  group: "mammals",
  food: "Insects such as ants and termites, beetle larvae and worms.",
  smallDescription:"Echidnas, also called spiny anteaters, are walking contradictions. They are mammals, but they lay eggs. They are often classified as long- or sort-beaked, but don't have beaks at all, in the traditional sense; they have fleshy noses that can be either on the long side or rather short.",
...
export const TasmanianDevil = {
  lifespan: "5 years",
  group: "mammals",
  food: "A predator, then eat meat from other animals such as wallabies and wombats.",
  smallDescription:"The Tasmanian devil (Sarcophilus harrisii) (palawa kani: purinina)[3] is a carnivorous marsupial of the family Dasyuridae. Until recently, it was only found on the island state of Tasmania, but it has been reintroduced to New South Wales in mainland Australia, with a small breeding population.",
...
export const quokka = { 
  ...
  smallDescription:" The Quokka, Setonix brachyurus, was described by early Dutch explorer, Willem de Vlamingh, 'as a kind of rat as big as a common cat'. His first sighting of the Quokka was on an island off the mouth of the Swan River. He named the island Rottenest ('rat nest') in honour of this sighting.",
...
export const FrillNeckedLizard = {
  lifespan: "20 years",
  group: "reptile",
  food: "Small insects and spiders.",
  smallDescription:"When this unique creature feels threatened, it rises on its hind legs, opens its yellow-coloured mouth, unfurls the colorful, pleated skin flap that encircles its head, and hisses. If an attacker is unintimidated by these antics, the lizard simply turns tail.",
...
export const HawksbillTurtle = {
lifespan: "50 years",
group: "reptile ",
food: "Other animals (sponges & jellyfish), sea plants.",
smallDescription:"The Hawksbill Sea Turtle gets its common name from the distinctive mouth, which resembles a bird’s beak. The shell, or carapace, is covered in large overlapping scutes, which are a distinctive brown/green/amber background with lighter brown streaks throughout.",
...
export const Perentie = { 
  lifespan: "20 years",
  group: "reptile",
  food: "Carnivore, they eat animals like kangaroos, rabbits, lizards and birds.",
  smallDescription:"The perentie (Varanus giganteus) is the largest monitor lizard or goanna native to Australia. It is one of the largest living lizards on earth, after the Komodo dragon, Asian water monitor, crocodile monitor, and intersecting by size with Nile monitor.",
...
export const Cassowary = {
  lifespan: "20 years",
  group: "bird",
  food: "Plants matter like fruit, insects and small animals like mice amd lizards.",
  smallDescription:"Its not hard to imagine that cassowaries are descended from dinosaur ancestors. The largest cassowaries can stand as high as six feet and weigh up to 160 pounds. These large birds cannot fly, but their extremely powerful legs propel them at great speeds.",
  description: "its not hard to imagine that cassowaries are descended from dinosaur ancestors. The largest cassowaries can stand as high as six feet and weigh up to 160 pounds.   These large birds cannot fly, but their extremely powerful legs propel them at great speeds. They are strong swimmers and can move quickly on both land and water. Cassowaries are shy and they are usually hard to spot, at least in their natural rain forest habitats. They are not overly aggressive, and attacks are rare. But they can do a lot of damage if they are provoked or angered. Cassowary attacks have occasionally been deadly, including a recent one which occurred in 2019, at a private collection of caged birds in Florida",
  length: "1.7m",
  weight: "44kg",
  found: "Queensland"
}

export const kookaburra = {
  lifespan: "20 years",
  group: "bird",
  food: "Insects and smalll animals including snakes, frogs and lizards.",
  smallDescription:"Native to the eucalyptus forests of eastern Australia, the laughing kookaburra is the largest member of the Kingfisher family, with females weighing up to one pound and growing to 43 cm in length. Its beak can reach 10 cm long and is used to snatch a variety of invertebrates and small vertebrates.",
...
export const yellowTailedBlackCockatoo = {
  lifespan: "41 years",
  group: "bird",
  food: "Fruit, seeds and other plant material.",
  smallDescription:"It has a short crest on the top of its head. Its plumage is mostly brownish black and it has prominent yellow cheek patches and a yellow tail band. The body feathers are edged with yellow giving a scalloped appearance.",
